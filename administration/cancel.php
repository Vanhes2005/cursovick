...
<body>
    ...
    $statementsResult = mysqli_query($db, "
        SELECT Statements.id_statement, Users.name, Users.surname, Users.patronymic, Statements.description, Statements.number_car, Statements.adress, Statements.date, 'Отклонено' as status
        FROM Users 
        INNER JOIN Statements ON Users.id_user = Statements.id_user
        WHERE Statements.status = 3
        ORDER BY $order
    ");
    ...
    ?><div class="admin-panel">
        <?php foreach ($statements as $statement): ?>
            <div class="statement" name="cancel.php">
